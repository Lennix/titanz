...
; URL.............:  http://www.autoit...opic=78834
...
Func _MemoryGetBaseAddress($ah_Handle, $iHexDec = 0)
    ...
    If Not IsArray($ah_Handle) Then
        SetError(1)
        Return "Error invalid $ah_Handle"
    EndIf
    ...
    If Not @Error Then
        ...
        Else
            SetError(2)
            Return "Error can't find the correct 'allocation Base' address"
        EndIf

    Else
        SetError(3)
        Return "Error failed to read from the specified process"
    EndIf
